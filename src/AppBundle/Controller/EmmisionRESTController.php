...
use AppBundle\Form\EmmisionType;
 ...
 * Emmision controller.
 *
 * @RouteResource("Emmision")
 */
class EmmisionRESTController extends VoryxController
{
    /**
     * Get a Emmision entity
     *
     * @View(
     ...
     * @param $entity
     *
     * @return Response|Emmision
     */
    public function getAction(Request $request, Emmision $entity)
    {
        return $entity;
    }

    /**
     * Get all Emmision entities.
     *
     * @View(
     *   serializerGroups={"Default"},
     *   serializerEnableMaxDepthChecks=true
    ...
    public function cgetAction(Request $request, ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('AppBundle:Emmision')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
     ...
     * @param Request $request
     *
     * @return FOSView|Response|Emmision
     */
    public function postAction(Request $request)
    {
        $entity = new Emmision();
        $form = $this->createForm(EmmisionType::class, $entity, array("method" => $request->getMethod()));
     ...
     * @return FOSView|Response|Emmision
     */
    public function putAction(Request $request, Emmision $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Emmision entity.
     *
     ...
     * @return Response
     */
    public function patchAction(Request $request, Emmision $entity)
    {
        return $this->putAction($request, $entity);
    }

    /**
     * Delete a Emmision entity.
     *
     * @View(statusCode=204)
     *
     * @param Request $request
     ...
     * @return FOSView|Response
     */
    public function deleteAction(Request $request, Emmision $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
